    ...
    const unsubscribeFromMonitor = async () => {
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(
            errorData.message || "Invalid or expired unsubscribe link"
          );
        }
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <Card className="w-full max-w-md">
          ...
          <CardBody className="flex flex-col items-center gap-4 py-6">
            ...
            <p className="text-center text-gray-600">
              You have been successfully unsubscribed from monitor
              notifications. The monitor has been deactivated and you will no
